...
export function CreateUserPage() {
  ...
  const selectedRoleOptions = formData.selectedRoles.map((role) => ({
    value: role,
    label: role,
  }));
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 pb-6 border-b border-gray-100 dark:border-gray-800">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight">Create New User</h1>
              <p className="text-gray-500 dark:text-gray-400 mt-1">Onboard a new member to your team</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8 pb-16">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 border border-gray-200 dark:border-gray-800 shadow-xl shadow-gray-100/50 dark:shadow-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label htmlFor="password" className="text-sm font-semibold text-gray-700 dark:text-gray-300">Set Password <span className="text-red-500">*</span></label>
                <input
                  type="password"
                  id="password"
                  name="password"
              ...
              <div className="space-y-2">
                <label htmlFor="confirmPassword" className="text-sm font-semibold text-gray-700 dark:text-gray-300">Confirm Password <span className="text-red-500">*</span></label>
                <input
                  type="password"
                  id="confirmPassword"
          ...
          <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 border border-gray-200 dark:border-gray-800 shadow-xl shadow-gray-100/50 dark:shadow-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
              <div className="md:col-span-3 space-y-2">
                ...
                <Select
                  isMulti
                  instanceId="create-user-roles-select"
                  name="roles"
                  options={roleOptions}
