...
export function Topbar({ onToggleSidebar, title }: TopbarProps) {
  ...
  return (
    <nav className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 py-3 sticky top-0 z-30">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          <button className="p-2 text-gray-600 dark:text-gray-400 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 relative">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="relative">
            ...
            >
              <div className="text-right hidden sm:block">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 leading-tight">{user?.email || 'user@example.com'}</p>
              </div>
