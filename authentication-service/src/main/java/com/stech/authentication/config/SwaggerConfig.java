...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                ...
                .info(new Info()
                    ...
                    .version("1.0")
                    .description("""
                        <h3>Authentication Service API Documentation</h3>
                        <p>This is the API documentation for the Authentication Service.</p>
    ...
    public GroupedOpenApi publicApi() {
        return GroupedOpenApi.builder()
                ...
                .pathsToMatch("/api/v1/auth/login", "/api/v1/auth/register")
                .build();
    }
    ...
    public GroupedOpenApi roleApis() {
        return GroupedOpenApi.builder()
                ...
                .pathsToMatch("/api/v1/auth/roles/**")
                .build();
    }
    ...
    public GroupedOpenApi permissionApis() {
        return GroupedOpenApi.builder()
                ...
                .pathsToMatch("/api/v1/auth/permissions/**")
                .build();
    }
}
